...
export const BOARD_SAVE_DELAY = 500;
export const BOARD_DEFAULT_IMAGE_SIZE = 128;
export const BOARD_ROTATION_BLOCK_INCREMENT = 45;
...
export const WINDOW_QUIT_WIDTH = 640;
export const WINDOW_QUIT_HEIGHT = 360;
...
export const BROWSER_THUMBNAILS_SELECTION_PERCENT = 0.4;
export const BROWSER_MAX_PREVIEW_COUNT = 30;
...
export const DB_COMPACTION_RETRY_COUNT = 10;
...
export const URL_PACKAGE_JSON = "http://18.183.141.141/ImagePetaPeta/package.json";
export const URL_DOWNLOAD = "https://github.com/takumus/ImagePetaPeta/releases/tag/v";
