...
export const WINDOW_MIN_WIDTH: number = 640;
export const WINDOW_MIN_HEIGHT: number = 360;
...
export const BROWSER_LOAD_THUMBNAIL_DELAY_RANDOM: number = 200;
export const BROWSER_FETCH_TAGS_DELAY: number = 200;
export const BROWSER_FETCH_TAGS_DELAY_RANDOM: number = 200;
