...
export const BROWSER_LOAD_ORIGINAL_DELAY_RANDOM: number = 800;
export const BROWSER_LOAD_THUMBNAIL_DELAY: number = 200;
export const BROWSER_LOAD_THUMBNAIL_DELAY_RANDOM: number = 800;
export const BROWSER_FETCH_TAGS_DELAY: number = 200;
export const BROWSER_FETCH_TAGS_DELAY_RANDOM: number = 800;
