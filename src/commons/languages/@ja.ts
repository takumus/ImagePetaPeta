...
const ja = {
  ...
  eula: {
    body: `下記の(壱), (弐), (参), (肆), (伍), (陸)の内容ついて、\n全て分かった方は「分かった」を押してください。\n「分かった」方のみ本アプリを利用できます。\n\n(壱). バグとかで、突然データが消えたりすることが絶対に無いとは言えません。\nデータ管理については結構慎重に開発したつもりですけど！\nもし問題が起きても、怒らないでください。\n\n(弐). あと、もしバグを見つけた時や、機能追加・改善等の要望がある場合は、\n設定画面の情報タブより報告してくれると、嬉しいです☺\n\n(参). 本アプリは、オープンソースです。プログラムの内容がすべて公開されていて、\n誰でも開発に参加できます。\n興味がある人は下記リポジトリを見てください。\nhttps://github.com/takumus/ImagePetaPeta\n\n(肆). NSFW機能は上手に使ってください。恥ずかしい思いをしないように。\n\n(伍). 本アプリを起動中の間、アップデートの確認のため、\n定期的にインターネットに接続します。\n\n(陸). ダウンロードしていただきありがとうございます！\n嬉しいです。`,
    agree: "分かった",
    disagree: "分からない",
  },
};
