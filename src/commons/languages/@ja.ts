const ja = {
  ...
  settings: {
    ...
    showBoard: "ボードのみ",
    showBrowser: "ブラウザのみ",
    showBoardBrowser: "ボードとブラウザ",
    showDescriptions: "起動時に表示する画面を設定できます。",
    ...
    loadThumbnailsInOriginalDescriptions: "ブラウザでズームした時に、フルサイズの画像を読み込みます。動作が重いと感じた場合は、この設定を無効にすることをおすすめします。",
