...
import Worker from "@/renderer/components/browser/property/worker/generateColorCircleWorker.worker";
...
export function generateColorCircle(
  petaImage: PetaImage,
  resolution: number,
  progress: (data: GenerateColorCircleWorkerOutputData) => void,
) {
  let cancel = () => {
    //
  };
