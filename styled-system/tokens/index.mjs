const tokens = {
  ...
  "spacing.px0": {
    "value": "2px",
    "variable": "var(--spacing-px0)"
  },
  "spacing.px1": {
    "value": "4px",
    "variable": "var(--spacing-px1)"
  },
  "spacing.px2": {
    "value": "8px",
    "variable": "var(--spacing-px2)"
  },
  "spacing.px3": {
    "value": "16px",
    "variable": "var(--spacing-px3)"
  },
  "spacing.px4": {
    "value": "32px",
    "variable": "var(--spacing-px4)"
  },
  "sizes.0": {
    "value": "0rem",
  ...
  "sizes.tabHeight": {
    "value": "24px",
    "variable": "var(--sizes-tab-height)"
  },
  "sizes.topDraggableHeight": {
    "value": "10px",
    "variable": "var(--sizes-top-draggable-height)"
  },
  "sizes.breakpoint-sm": {
    "value": "640px",
  ...
  "fontSizes.size0": {
    "value": "0.8em",
    "variable": "var(--font-sizes-size0)"
  },
  "fontSizes.size1": {
    "value": "1em",
    "variable": "var(--font-sizes-size1)"
  },
  "fontSizes.size2": {
    "value": "1.2em",
    "variable": "var(--font-sizes-size2)"
  },
  "borderWidths.window": {
    "value": "1px",
    "variable": "var(--border-widths-window)"
  },
  "shadows.2xs": {
  ...
  "colors.surfaceFloating": {
    "value": "var(--color-0-floating)",
    "variable": "var(--colors-surface-floating)"
  },
  "colors.surfaceMuted": {
    "value": "var(--color-1)",
    "variable": "var(--colors-surface-muted)"
  },
  "colors.surfaceEmphasis": {
    "value": "var(--color-2)",
    "variable": "var(--colors-surface-emphasis)"
  },
  "colors.accent": {
  ...
  "colors.accentStrong": {
    ...
    "variable": "var(--colors-accent-strong)"
  },
  "colors.border": {
  ...
  "colors.overlay": {
    "value": "var(--color-overlay)",
    "variable": "var(--colors-overlay)"
  },
  "colors.text": {
    "value": "var(--color-font)",
    "variable": "var(--colors-text)"
  },
  "colors.checkboxFalseBackground": {
    "value": "var(--color-checkbox-false-background)",
    "variable": "var(--colors-checkbox-false-background)"
  },
  "colors.checkboxFalseCircle": {
    "value": "var(--color-checkbox-false-circle)",
    "variable": "var(--colors-checkbox-false-circle)"
  },
  "colors.checkboxTrueBackground": {
    "value": "var(--color-checkbox-true-background)",
    "variable": "var(--colors-checkbox-true-background)"
  },
  "colors.checkboxTrueCircle": {
    "value": "var(--color-checkbox-true-circle)",
    "variable": "var(--colors-checkbox-true-circle)"
  },
  "colors.windowButton": {
    "value": "var(--color-window-button)",
    "variable": "var(--colors-window-button)"
  },
  "colors.closeHover": {
    "value": "var(--window-buttons-close-hover)",
    "variable": "var(--colors-close-hover)"
  },
  "spacing.-1": {
  ...
  "spacing.-px0": {
    "value": "calc(var(--spacing-px0) * -1)",
    "variable": "var(--spacing-px0)"
  },
  "spacing.-px1": {
    "value": "calc(var(--spacing-px1) * -1)",
    "variable": "var(--spacing-px1)"
  },
  "spacing.-px2": {
    "value": "calc(var(--spacing-px2) * -1)",
    "variable": "var(--spacing-px2)"
  },
  "spacing.-px3": {
    "value": "calc(var(--spacing-px3) * -1)",
    "variable": "var(--spacing-px3)"
  },
  "spacing.-px4": {
    "value": "calc(var(--spacing-px4) * -1)",
    "variable": "var(--spacing-px4)"
  },
  "colors.colorPalette": {
