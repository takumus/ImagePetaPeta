/* eslint-disable */
export type Token = `aspectRatios.${AspectRatioToken}` | `borders.${BorderToken}` | `easings.${EasingToken}` | `durations.${DurationToken}` | `fontWeights.${FontWeightToken}` | `lineHeights.${LineHeightToken}` | `fonts.${FontToken}` | `letterSpacings.${LetterSpacingToken}` | `colors.${ColorToken}` | `blurs.${BlurToken}` | `animations.${AnimationToken}` | `spacing.${SpacingToken}` | `sizes.${SizeToken}` | `radii.${RadiusToken}` | `fontSizes.${FontSizeToken}` | `borderWidths.${BorderWidthToken}` | `shadows.${ShadowToken}` | `breakpoints.${BreakpointToken}`

export type ColorPalette = "current" | "black" | "white" | "transparent" | "rose" | "pink" | "fuchsia" | "purple" | "violet" | "indigo" | "blue" | "sky" | "cyan" | "teal" | "emerald" | "green" | "lime" | "yellow" | "amber" | "orange" | "red" | "neutral" | "stone" | "zinc" | "gray" | "slate" | "surface" | "surfaceFloating" | "surfaceMuted" | "surfaceEmphasis" | "accent" | "accentStrong" | "border" | "overlay" | "text" | "checkboxFalseBackground" | "checkboxFalseCircle" | "checkboxTrueBackground" | "checkboxTrueCircle" | "windowButton" | "closeHover"
